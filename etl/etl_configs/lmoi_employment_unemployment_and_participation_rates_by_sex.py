# etl/etl_configs/lmoi_employment_unemployment_and_participation_rates_by_sex.py
"""
...
def create_lmoi_employment_unemployment_and_participation_rates_by_sex_etl_config() -> ETLConfig:
    ...
    metric_config = MetricConfig(
        ...
        # Основные данные
        slug="Labour market outcomes of immigrants - Employment, unemployment, and participation rates by sex",
        name="Результаты трудоустройства иммигрантов: занятость, безработица и участие в рабочей силе в зависимости от пола",
        description="Результаты трудоустройства иммигрантов: занятость, безработица и участие в рабочей силе в зависимости от пола",
        ...
        attributes=[
            ...
            AttributeConfig(
                ...
                custom_parser=parse_column_sex,
            ),
            AttributeConfig(
                # Основные данные
    ...
    config = ETLConfig(
        ...
        csv_file="data/OECD.ELS.IMD,DSD_MIG@DF_MIG_NUP_SEX,1.0+all.csv",
        csv_delimiter=";",
