    ...
    with open(file_path, encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            for country_code in country_iso_alpha3_codes:
                ...
                source_url = "https://data-explorer.oecd.org/vis?df[ds]=DisseminateFinalDMZ&df[id]=DSD_MIG%40DF_MIG_EMP_EDU&df[ag]=OECD.ELS.IMD&dq=..A.....&to[TIME_PERIOD]=false&vw=tb&pd=2020%2C2024"
